...
const FString SchemaBundleFieldDefinition::WRITE_ACL_MAP{ TEXT("improbable.WriteACLMap") };
const FString SchemaBundleFieldDefinition::COMPONENT_INTEREST_MAP{ TEXT("improbable.ComponentInterestMap") };
